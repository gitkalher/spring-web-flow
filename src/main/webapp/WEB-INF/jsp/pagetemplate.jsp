	...
	<body>
		<div id="doc">
			<div id="hd">
				...
				<div>
					<a href="${contextPath}/home.xhtml">Home</a> |
					<a href="${contextPath}/checkout.xhtml">Checkout</a> |
					<a href="${contextPath}/account/register.xhtml">Create Account</a> |
					<a href="${contextPath}/account/login.xhtml">Login</a>
				</div>
			</div>
			<decorator:body/>
			<div id="ft">
